          ...
          <div className="row g-4">
            ...
            {awardsData?.map((item, index) => (
              <div className="col-md-6" key={item._id}>
                ...
                <div className="awards-item d-flex align-items-center justify-content-between" data-aos="fade-up" data-aos-delay={(index + 1) * 200}>
                  <div className="content d-flex align-items-center">
                    <div className="icon me-3">
                      <img src={item.iconImage} alt="icon" className="small-icon" />
                    </div>
                    <div className="text">
                  ...
                  <div className="main-image">
                    <img src={item.image} alt="image" className="big-image" />
                  </div>
                </div>
              </div>
            ))}
